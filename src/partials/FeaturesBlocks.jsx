      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Customize Your Comment Recommendations.</h2>
            <p className="text-xl text-gray-400">SNS-GPT takes into account factors such as age, profession, and language to provide tailored comment recommendations.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Customized</h4>
              <p className="text-lg text-gray-400 text-center">SNS-GPT provides personalized comment recommendations by taking into account various user information such as age, occupation, gender, and language.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Emoji</h4>
              <p className="text-lg text-gray-400 text-center">Considering the use of emojis, we recommend appropriate emojis to make it easier for users to understand.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Polite</h4>
              <p className="text-lg text-gray-400 text-center">SNS-GPT considers the use of informal language and recommends appropriate comments using polite language.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Hashtag</h4>
              <p className="text-lg text-gray-400 text-center">We recommend popular hashtags based on user preferences and trends to help with comment writing.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Diverse Keyword</h4>
              <p className="text-lg text-gray-400 text-center">SNS-GPT recommends various keywords based on user interests and preferences to assist with comment writing.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Modern UX/UI</h4>
              <p className="text-lg text-gray-400 text-center">SNS-GPT provides a modern user experience by leveraging the latest technology and design principles.</p>
            </div>
